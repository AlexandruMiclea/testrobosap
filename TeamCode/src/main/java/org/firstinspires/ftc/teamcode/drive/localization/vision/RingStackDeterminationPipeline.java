...
public class RingStackDeterminationPipeline extends OpenCvPipeline {
    /*
    ...
    //TODO redo
    static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(800,350);

    static final int REGION_WIDTH = 270;
