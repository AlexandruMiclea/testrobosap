...
import org.firstinspires.ftc.teamcode.drive.localization.localizers.AnalogEncoderLocalizerMR;
 ...
 */
@Config
public class MecanumDriveChassisMR extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(4.1, 1.3, 0.3); //TODO cause these the old ones
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(55, 10, 7); //TODO same here
    ...
    public MecanumDriveChassisMR(HardwareMap hardwareMap) {
        ...
        setLocalizer(new AnalogEncoderLocalizerMR(hardwareMap));
    }
